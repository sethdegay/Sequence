...
include(":core:timer")
include(":core:ui")
include(":feature:calendarevent:list:api")
include(":feature:calendarevent:list:impl")
include(":feature:home:api")
include(":feature:home:impl")
include(":feature:license:api")
include(":feature:license:impl")
include(":feature:segment:contextmenu:api")
include(":feature:segment:contextmenu:impl")
