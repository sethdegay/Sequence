...
object SequenceIcons {
    ...
    val Delete @Composable get() = ImageVector.vectorResource(drawable.delete_24px)
    ...
    val Pick @Composable get() = ImageVector.vectorResource(drawable.pick_24px)
    ...
    val Remove @Composable get() = ImageVector.vectorResource(drawable.remove_24px)
